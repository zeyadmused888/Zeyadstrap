...
namespace Zeyadstrap.UI.Elements.Settings
{
    /// <summary>
    ...
    public partial class MainWindow : INavigationWindow
    {
        ...
        {
            string details = e.Content switch
            {
                Pages.IntegrationsPage => "Configuring integrations",
                Pages.BehaviourPage => "Configuring launcher behavior",
                Pages.ModsPage => "Managing mods",
                Pages.FastFlagsPage => "Editing Fast Flags",
                Pages.FastFlagEditorPage => "Editing Fast Flags",
                Pages.AppearancePage => "Customizing Zeyadstrap",
                Pages.ShortcutsPage => "Managing shortcuts",
                Pages.BloxstrapPage => "Configuring Zeyadstrap",
                _ => "In settings"
            };

            LaunchHandler.SetLauncherRichPresence(details, "In settings");
        }
